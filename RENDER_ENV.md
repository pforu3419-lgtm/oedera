...
| **ORDERA_MASTER_CODE** | รหัสสำหรับเข้าหน้า /create-admin-codes (เช่น `ordera-master-2024`) | จำเป็นถ้าต้องการสร้างรหัสแอดมิน |
...
| Key | ใช้เมื่อ |
|-----|----------|
| NODE_VERSION | ใช้ Node 20 (เช่น `20`) — แก้ SSL กับ MongoDB |
